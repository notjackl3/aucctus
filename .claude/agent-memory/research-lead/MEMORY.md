...
- [jtbd_scan_architecture.md](jtbd_scan_architecture.md) - JTBD scan initiation flow, isScanning timing gap, WS events inventory, progress bar rendering conditions (2026-04-15)
