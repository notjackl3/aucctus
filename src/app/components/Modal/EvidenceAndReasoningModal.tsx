  ...
  return (
    <div className='inline-flex flex-col items-center justify-start rounded-xl'>
      ...
      <div className='inline-flex h-full w-full items-start justify-start'>
        ...
        <ScrollArea.Root className='flex h-auto min-w-[260px] max-w-96 flex-col items-start justify-start overflow-hidden scroll-smooth rounded-br-xl bg-neutral-50 pt-6'>
