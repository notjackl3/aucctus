      ...
      <div className='inline-flex h-full w-full items-start justify-start'>
        <div className='inline-flex min-w-[260px] max-w-96 flex-col items-start justify-start gap-5 self-stretch border-r border-gray-300 p-6'>
          ...
          <div className='flex h-16 flex-col items-center justify-center gap-2.5 self-stretch'>
            ...
            <p className='self-stretch text-2xl font-bold text-indigo-900'>
              {conclusion}
            </p>
          </div>
          {/* Reasoning */}
          <div className='flex flex-col items-center justify-center gap-2.5 self-stretch'>
            ...
            <p className='self-stretch text-sm font-medium leading-tight text-gray-500'>
              {reasoning}
            </p>
          </div>
        </div>

        <ScrollArea.Root className='flex h-auto max-h-96 min-w-[260px] max-w-96 flex-col items-start justify-start overflow-hidden scroll-smooth rounded-br-xl bg-neutral-50 pt-6'>
