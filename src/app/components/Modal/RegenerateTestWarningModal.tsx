...
const RegenerateTestWarningModal: React.FC<RegenerateTestWarningModalProps> = ({
  ...
  return (
    <div className='aucctus-bg-primary relative inline-flex max-h-[80vh] w-[600px] flex-col items-center justify-start rounded-xl'>
      {/* Header */}
      ...
      {/* Scrollable Assumptions Content */}
      ...
      <div className='aucctus-border-secondary w-full border-t px-6 py-4'>
