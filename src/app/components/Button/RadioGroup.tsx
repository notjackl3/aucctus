...
const RadioGroup: React.FC<IRadioGroup> = ({
  ...
  >
    {labels.map((value, index) => (
      ...
      >
        <Radio.Item
          className='aucctus-border-primary aucctus-bg-secondary-subtle h-[25px] w-[25px] cursor-default rounded-full border shadow-md outline-none hover:outline-primary-400 focus:shadow-lg'
          value={value}
          id={`r${index + 1}`}
        >
        ...
        <label
          className='aucctus-text-tertiary pl-2 text-base font-medium capitalize leading-tight'
          htmlFor={`r${index + 1}`}
        >
