...
const ManualAnswer: React.FC<ManualAnswerProps> = ({
  ...
  return (
    <animated.div
      ...
      className='aucctus-text-white relative min-w-[250px] max-w-[350px] select-none rounded-xl border border-white/30 bg-white/10 p-3 shadow-lg backdrop-blur-md transition-all duration-200 hover:bg-white/15'
    >
