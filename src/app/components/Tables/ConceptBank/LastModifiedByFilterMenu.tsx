...
export interface ILastModifiedByFilterMenuProps {
...
/**
 * Last Modified By filter menu for table header
 * Provides searchable multi-select user selection for filtering by last modifier (OR logic)
 */
const LastModifiedByFilterMenu: React.FC<ILastModifiedByFilterMenuProps> = ({
  filterOptions,
  updateFilterOptions,
  ...
  }, [isOpen, filterOptions.lastModifiedBy]);
        ...
        <Popover.Trigger asChild>
          ...
          >
            <span className='flex items-center gap-1.5'>
              <UserPen className='aucctus-stroke-tertiary h-4 w-4' />
              Last Modified By
              {hasActiveFilter && (
                      ...
                      {onSort && (
                        <>
                          ...
                          >
                            ...
                            <span className='aucctus-text-secondary'>Sort</span>
...
export default LastModifiedByFilterMenu;
