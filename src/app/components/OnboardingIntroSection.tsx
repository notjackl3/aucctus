...
const OnboardingIntoSection: FunctionComponent = () => {
  return (
    <div className={`${styles.intoSection}  ${styles.onboarding}`}>
      ...
      <OnboardingMessage title={"Instant Industry Intel"} description={"Dive in and dominate with on-the-spot market insights"}
        icon={"target"} color={"purple"} />
      <OnboardingMessage title={"Idea Factory"} description={"Let innovation flow! We generate and rank your next big moves"}
        icon="lightbulb" color={"purple"} />
      <OnboardingMessage title={"Persona Magic"} description={"Tailor-made strategies that resonate with your ideal audience"}
        icon="userGroup" color={"purple"} />
