...
const ChartLongArrow: FunctionComponent<ChartLongArrow> = ({ percentList }) => {
  const renderArrowText = (percentList: string[]) => {
    if (!percentList || percentList.length === 0) return null;
    return percentList.map((percent, i) => {
