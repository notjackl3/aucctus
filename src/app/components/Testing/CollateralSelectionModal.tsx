...
const CollateralSelectionModal: React.FC<CollateralSelectionModalProps> = ({
  ...
  const modalContent = (
    <div
      className='glass-modal-overlay fixed inset-0 z-[100] flex items-center justify-center'
    ...
    >
      ...
      >
        <div className='liquid-glass-modal-shell'>
          ...
          <div className='liquid-glass-modal-surface flex max-h-[80vh] flex-col'>
            {/* Header */}
                        ...
                        <div key={type}>
                          ...
                          <div className='ml-6 space-y-3'>
                            {typeCollaterals.map((collateral) => {
                              const isSelected =
                                selectedCollateralUuids.includes(
                                  collateral.uuid,
                                );
                              const isDisabled =
                                !isSelected &&
