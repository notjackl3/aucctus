        ...
        <div className='aucctus-bg-primary aucctus-border-primary rounded-lg border p-6 shadow-sm'>
          ...
          <div className='mb-6'>
            <p className='aucctus-text-sm aucctus-text-secondary'>
              These projections simulate possible cost savings outcomes based on
              your savings method, impact sizing, and operational efficiency
              inputs. It helps you understand the range and probability of
              possible savings outcomes.
            </p>
          </div>
