      ...
      {viewMode === 'raw' && result.rawInterviewTranscript ? (
        ...
        <div className='space-y-6'>
          {result.keyInsights && (
            <div className='space-y-3'>
              <div className='flex items-center gap-2'>
                <Lightbulb className='aucctus-stroke-brand-primary h-4 w-4' />
          ...
          {result.solutionFeedback && (
            <div className='space-y-3'>
              <div className='flex items-center gap-2'>
                <MessageCircle className='aucctus-stroke-success-primary h-4 w-4' />
                <h3 className='aucctus-text-sm-medium aucctus-text-primary'>
                  Solution Feedback
                </h3>
              </div>
          ...
          {result.overallSentiment && (
            <div className='space-y-3'>
              <div className='flex items-center gap-2'>
                <Heart className='aucctus-stroke-error-primary h-4 w-4' />
                <h3 className='aucctus-text-sm-medium aucctus-text-primary'>
                  Overall Sentiment
                </h3>
              </div>
