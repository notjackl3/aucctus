...
export type SettingsSection = 'seed-summary' | 'data-documents';
...
const SettingsSidebar: React.FC<SettingsSidebarProps> = ({
  ...
  const sections: SettingsSectionItem[] = React.useMemo(
    () => [
      { id: 'seed-summary', label: 'Concept Inputs', icon: Lightbulb },
      {
        id: 'data-documents',
        label: 'Data & Uploads',
        icon: Database,
                ...
                const sectionItem = (
                  ...
                  >
                    <div className='relative flex-shrink-0'>
                      ...
                      {section.badge && !expanded && (
                        <div className='absolute -right-1.5 -top-1.5 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-emerald-500 text-[8px] font-bold text-white'>
