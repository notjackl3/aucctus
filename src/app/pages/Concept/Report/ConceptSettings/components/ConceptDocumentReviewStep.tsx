/**
 * ConceptDocumentReviewStep — Review body and footer for the concept document modal.
 * Mirrors the Living Personas DocumentReviewStep pattern.
 */
...
import ConceptInsightCard from './ConceptInsightCard';

export interface ConceptDocumentReviewStepProps {
  insights: ConceptInsightItem[];
  changeInsights: ConceptInsightItem[];
  contextInsights: ConceptInsightItem[];
  pendingCount: number;
...
export const ConceptDocumentReviewStep: React.FC<
  ConceptDocumentReviewStepProps
> = ({
  insights,
  changeInsights,
  contextInsights,
...
export const ConceptDocumentReviewStepFooter: React.FC<
  Pick<
    ConceptDocumentReviewStepProps,
