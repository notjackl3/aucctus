/**
 * ConceptInsightCard — 4-column card for displaying and acting on extracted evidence.
 * Mirrors the Living Personas InsightCard pattern.
 */
...
export interface ConceptInsightCardProps {
  insight: ConceptInsightItem;
...
const ConceptInsightCard: React.FC<ConceptInsightCardProps> = React.memo(
  function ConceptInsightCard({
    ...
    const widgetCfg =
      WIDGET_ICON_CONFIG[insight.targetSection] ?? DEFAULT_WIDGET_ICON;
          ...
          <div className='flex-1 p-4'>
            <div className='mb-2 flex items-center gap-2'>
              ...
              <span className='aucctus-text-tertiary text-[10px] font-medium uppercase tracking-wide'>
                {SECTION_LABELS[insight.targetSection] || insight.targetWidget}
              </span>
            </div>
...
export default ConceptInsightCard;
