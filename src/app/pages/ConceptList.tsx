  ...
  const columns = useMemo(
    () => [
      columnHelper.accessor((row) => row.title, {
        ...
        cell: (data) => (
          <div className={styles.details}>
            ...
            <span className={styles.summary}>{data.row.original.summary}</span>
          </div>
        ),
      }),
      ...
      columnHelper.accessor((row) => row.updatedAt, {
        ...
        cell: (info) => (
          <i>
            {new Date(info.getValue()).toLocaleDateString('en-US', { year: '2-digit', month: 'short', day: 'numeric' })}
          </i>
        ),
      ...
      <div className={styles.headerSection}>
        ...
        <div className={styles.navbar}>
          <div className={`${styles.link} ${styles.active}`}>
            <Link to={AppPath.ConceptList}>Concepts</Link>
          </div>
        ...
        <table>
          ...
          <tbody>
            {query.isLoading ? (
              ...
              <div className={styles.tableMessageContainer}>
                <img alt="Ignite your Concept" src={ignite} />
              </div>
            ) : (
