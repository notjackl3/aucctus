...
export const initialOverseerState = {
  ...
  navigateSuggestion: null as IOverseerNavigateSuggestion | null,
...
const overseerSlice: Lens<IOverseerState, IAppStore> = (set, get, storeApi) => {
  ...
  return {
    ...
    processQueuedMessage: processQueuedMessage.bind(actionContext),
    clearMessageQueue: clearMessageQueue.bind(actionContext),
    ...
    handleNavigateSuggestion: handleNavigateSuggestion.bind(actionContext),
